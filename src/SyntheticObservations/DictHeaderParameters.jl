...
const DictHeader = Dict(
    ...
    "ne" => header_params(naxis=3, ctype3="DIST", cunit3="pc", bunit="cm^-3"),
    "NHI" => header_params(naxis=2, bunit="cm^-2"),
    "nCNM" => header_params(naxis=3, ctype3="DIST", cunit3="pc", bunit="cm^-3"),
    "nLNM" => header_params(naxis=3, ctype3="DIST", cunit3="pc", bunit="cm^-3"),
    "nWNM" => header_params(naxis=3, ctype3="DIST", cunit3="pc", bunit="cm^-3"),
    ...
    "intBLOS" => header_params(naxis=2, bunit="muG cm"),
    "sigmaBLOS" => header_params(naxis=2, bunit="muG"),
    "intBtotal" => header_params(naxis=2, bunit="muG cm"),
    "sigmaBtotal" => header_params(naxis=2, bunit="muG"),
    "intBperp" => header_params(naxis=2, bunit="muG cm"),
